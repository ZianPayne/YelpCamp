...
router.route('/')
    ...
    .post(isLoggedIn, upload.array('campground[images]'), logRequestAndFiles, validateCampground, catchAsync(campgrounds.createCampground));
...
router.route('/:id')
    ...
    .put(isLoggedIn, isAuthor, upload.array('campground[images]'), logRequestAndFiles, validateCampground, catchAsync(campgrounds.updateCampground))
